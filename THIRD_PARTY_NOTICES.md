...
- MolRep's repository license is CC BY-NC-ND 4.0. No distinct license for its linked Liver data files was identified. Those files and all molecule-level derivatives are omitted. The source-derived Liver aggregate tables retain attribution, are excluded from the root MIT scope, and assert no additional reuse permission. No MolRep source code is copied.
...
- The Pharmaco-Explainer code repository is MIT at commit `f40599677e52574b86d8e7ccc6dc842471519cbd`. Its source tree and source code are not bundled; the pharmacophore adapter scripts in this repository are repository-authored.
